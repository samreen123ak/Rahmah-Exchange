    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      >
        ...
        <nav className="hidden lg:flex items-center gap-6 xl:gap-8">
          ...
          <Link
            href="/staff/login"
            className="bg-white text-teal-700 px-4 xl:px-5 py-2 rounded-full text-sm font-semibold hover:bg-gray-100 hover:shadow-lg transition whitespace-nowrap"
          >
            Admin Login
          </Link>
        </nav>
        ...
        <button
          ...
          className="lg:hidden p-2 text-white hover:bg-teal-600 rounded-lg transition"
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-teal-700 shadow-xl lg:hidden">
            <nav className="flex flex-col py-4">
              <button
                onClick={() => scrollToSection("home")}
                className={`px-6 py-3 text-left transition ${activeSection === "home" ? "bg-teal-600 text-white" : "text-white/80 hover:bg-teal-600 hover:text-white"}`}
              >
                Home
              </button>
              <button
                onClick={() => scrollToSection("about")}
                className={`px-6 py-3 text-left transition ${activeSection === "about" ? "bg-teal-600 text-white" : "text-white/80 hover:bg-teal-600 hover:text-white"}`}
              >
                About Us
              </button>
              <button
                onClick={() => scrollToSection("services")}
                className={`px-6 py-3 text-left transition ${activeSection === "services" ? "bg-teal-600 text-white" : "text-white/80 hover:bg-teal-600 hover:text-white"}`}
              >
                Services
              </button>
              <button
                onClick={() => scrollToSection("reviews")}
                className={`px-6 py-3 text-left transition ${activeSection === "reviews" ? "bg-teal-600 text-white" : "text-white/80 hover:bg-teal-600 hover:text-white"}`}
              >
                Reviews
              </button>
              <button
                onClick={() => scrollToSection("faq")}
                className={`px-6 py-3 text-left transition ${activeSection === "faq" ? "bg-teal-600 text-white" : "text-white/80 hover:bg-teal-600 hover:text-white"}`}
              >
                FAQ's
              </button>
              <Link
                ...
                className="mx-6 mt-2 mb-4 bg-white text-teal-700 px-5 py-2 rounded-full text-sm font-semibold hover:bg-gray-100 hover:shadow-lg transition text-center"
              >
                Admin Login
              </Link>
            </nav>
          ...
          <div className="flex-1 animate-fadeInUp text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
              <Link href="/form" className="w-full sm:w-auto">
                <button className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white text-teal-700 rounded-lg font-semibold hover:shadow-xl hover:scale-105 transition-all text-sm sm:text-base">
